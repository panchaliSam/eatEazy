...
import logo from '../assets/HeroSectionFood.jpg';
        ...
        >
            ...
            <Box sx={{ position: 'relative' }}>
                <Typography variant="h3" sx={{ fontWeight: 'bold', mb: 2 }}>
                    We Offer <Typography component="span"  variant="h3" sx={{ color: 'orange' }}>Delicious Food</Typography> <br /> And Quick Service
                </Typography>
